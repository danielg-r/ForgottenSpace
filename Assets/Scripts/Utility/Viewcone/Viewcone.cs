...
public class Viewcone : MonoBehaviour
{
	...
	static Color myYellow = new Color(1, 0.92f, 0.016f, 0.5f);
	...
	public void Rebuild ()
	{
		...
		GetComponent<Renderer>().sharedMaterial = new Material(Shader.Find("Universal Render Pipeline/Unlit")) {color = Color.yellow}; // REF1
		GetComponent<Renderer>().sharedMaterial.SetColor("_BaseColor", myYellow);
